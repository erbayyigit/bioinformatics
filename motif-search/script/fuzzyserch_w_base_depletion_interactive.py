...
#pey214 = 'AAAAHA'
motif = input("Enter motif in Upperca DNA letters: ")
max_l_dist_     = int(input("Max distance:0 for perfect match [defaul]t, 1 for single mismatch etc.: ") or "0")
max_deletions_  = int(input("max_deletions, leave empty for default 0: ") or "0")
max_insertions_ = int(input("max_insertions, leave emtpy for default 0: ") or "0")


fasta_file_name     = 'minigfp-fasta.fa' #input filename
out_fasta_filename  = f"_recoded_{fasta_file_name}"
outfasta = open(out_fasta_filename, 'w+')       

inpu_file_basename = fasta_file_name.rstrip('.fasta') 
